...
namespace _3DRTSGame
{
	public static class CircleRenderer
	{
		...
		/*public CircleRenderer(Game1 game, Color color, float radius)
		{
			_Game = game;
		...
		public static void Draw(GraphicsDevice graphicsDevice, Matrix view, Matrix projection, Matrix transforms, Color color, float radius)
		{
			if (_Effect == null) {
